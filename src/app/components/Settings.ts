...
import Config, {
  XBOptionType,
  XBOptionTypeSpinnerOptions,
} from "xbreader/models/Config";
  ...
  view({ attrs }: CVnode<SettingsAttrs>) {
    return m(
      ...
      m("div.br-dialog", [
        ...
        m(
          "form.br-form",
          attrs.config.settings.map((setting) => {
            ...
            switch (setting.type) {
                ...
                return m("div.br-form__input", [
                  ...
                  m(
                    ...
                    setting.options.map((option) => [
                      ...
                      m(
                        "label.br-form__input-radio__label",
                        {
              ...
              case XBOptionType.Dropdown:
                return m("div.br-form__input", [
                  ...
                  m(
                    "select.br-form__input-dropdown",
                    {
              ...
              case XBOptionType.SpinnerPercentage: {
                ...
                return m("div.br-form__input", [
                  ...
                  m(
                    "div.br-form__input-spinner.label",
                    setting.type === XBOptionType.Spinner
                      ? (setting.value as number).toFixed(1)
                      : `${Math.floor((setting.value as number) * 100)}%`
                  ),
